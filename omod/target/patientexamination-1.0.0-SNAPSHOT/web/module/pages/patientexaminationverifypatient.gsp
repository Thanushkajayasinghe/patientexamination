...
<div class="row">
  ...
  <div class="col-md-12 form-group">
    <div class="row justify-content-center">
      <div class="col-md-5">
        <a href="/openmrs/patientexamination/patientexaminationdata.page" type="button" class="btn-block btn-success btn-lg btn3d" id="btnVerifyPatient" style="padding: 20px;font-size: 1.5rem;text-align: center;font-weight: 700;color: black; text-decoration: none; ">
