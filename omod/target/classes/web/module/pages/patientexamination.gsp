...
<div class="row">
  ...
  <div class="col-md-6 form-group">
    ...
    <div class="card" style="background: #013568;border-radius: 10px;">
      <div class="card-body text-center" style="color: white; padding: 4px;">
        <h2 style="color: white;font-weight: bold;">Total Pending Patients: <span id="lblPendingPatients">10 </span></h2>
      </div>
    </div>
  ...
  <div class="col-md-6 form-group">
    <div class="row">
      ...
      <div class="col-12 form-group">
        <input type="text" class="form-control" placeholder="Enter Token/ PHN" style="height: 60px; font-size: 2.3rem; font-weight: bold; text-align: center; border-color: #80bdff; outline: 0;">
      </div>
      <div class="col-12">
        <div class="row">
          <div class="col-md-6 form-group">
            <button type="button" class="btn-block btn-info btn-lg btn3d" id="btnCallToken" style="background: #39B3D7;">
          ...
          <div class="col-md-6 form-group">
            <button type="button" class="btn-block btn-danger btn-lg btn3d" id="btnCallPhn" style="background: #D73814;">
              <span class="fa fa-phone" style="font-size: 2rem;display: block;"></span>
  ...
  <div class="col-md-12 form-group">
    <div class="row justify-content-center">
      <div class="col-md-5">      
        <a href="/openmrs/patientexamination/patientexaminationverifypatient.page" type="button" class="btn-block btn-warning btn-lg btn3d" id="startCounselling" style="padding: 20px;font-size: 1.5rem;text-align: center;font-weight: 700;color: black; text-decoration: none; ">
...
<script type="text/javascript">
    $(document).ready(function() {
        document.title = 'Patient Examination - Call Token';
    });
</script>
